...
def get_args():
    ...
    parser.add_argument('--save_freq', type = int, default=100, help = 'save freq')

    parser.add_argument('--resume', action='store_true', default=False, help = 'autoresume training (interrupted by accident)')

    parser.add_argument('--test', action='store_true', default=False)

    parser.add_argument('--amp', action='store_true', default=False, help='whether to use automatic mixed precision training')

    parser.add_argument('--swanlab', action='store_true', default=False, help='whether to use swanlab')
